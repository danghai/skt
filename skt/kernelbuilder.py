...
class KernelBuilder(object):
    ...
    def __make_redhat_config(self):
        ...
        config = skt.join_with_slash(
            escaped_source_dir,
            "configs",
            "kernel*{}.config".format(self.config_arch)
        )
    ...
    def __set_build_arch(self, build_arch):
